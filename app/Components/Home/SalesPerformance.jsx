...
export default function SalesPerformance() {
  return (
    <div className="bg-white dark:bg-slate-800 shadow dark:shadow-lg rounded-xl p-4 col-span-2 h-96 min-h-[380px] transition-colors duration-300">
      {/* Header */}
      <div className="flex justify-between items-center mb-4">
        <h2 className="font-semibold dark:text-gray-100 transition-colors duration-300">Sales Performance</h2>

        <div className="flex gap-3 text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">
          <span className="cursor-pointer hover:text-gray-700 dark:hover:text-gray-300 transition-colors duration-300">Today's</span>
          <span className="cursor-pointer text-gray-800 dark:text-gray-200 font-semibold transition-colors duration-300">Monthly</span>
        </div>
      </div>
