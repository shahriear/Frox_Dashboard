...
const Navber = ({ onToggleSidebar, sidebarOpen }) => {
  ...
  return (
    <>
      ...
      <div className=" bg-[var(--section-bg)] border-b border-b-gray-400  shadow-xl hidden sm:flex w-full h-16 sm:h-20 lg:h-24 items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 sm:gap-8 md:gap-40 lg:gap-64 justify-center lg:justify-center">
          ...
          <div className="hidden md:block w-32 sm:w-40 lg:w-[360px] h-8 sm:h-10 lg:h-12 shrink-0">
            <input
              className="w-full h-full border border-gray-500 shadow-2xs bg-[#F5F5F] pl-4 sm:pl-8 lg:pl-10 rounded-2xl text-xs sm:text-sm lg:text-base"
              placeholder="Search"
              type="search"
            />
          </div>
